...
INCIDENT_SCENARIOS = [
    {
        ...
        "options": [
            {
                "id": "a",
                "text": "Scale down to zero and go home",
                "correct": False,
                "feedback": "That's... not how on-call works.",
            },
            {
                "id": "b",
                "text": "Check target group health & recent deployments",
                "correct": True,
                "feedback": "Smart! Always correlate health checks with recent changes.",
            },
            {
                "id": "c",
                "text": "Delete the load balancer",
                "correct": False,
                "feedback": "Please no. The LB is not the problem.",
            },
            {
                "id": "d",
                "text": "Reboot your laptop",
                "correct": False,
                "feedback": "Your laptop is fine. The servers aren't.",
            },
        ],
    },
    {
        ...
        "options": [
            {
                "id": "a",
                "text": "Increase max_connections & investigate connection leaks",
                "correct": True,
                "feedback": "Good triage — fix the immediate issue, then find the leak.",
            },
            {
                "id": "b",
                "text": "DROP DATABASE production",
                "correct": False,
                "feedback": "Absolutely not. Step away from the terminal.",
            },
            {
                "id": "c",
                "text": "Add more RAM to the app servers",
                "correct": False,
                "feedback": "RAM won't fix a connection pool exhaustion.",
            },
            {
                "id": "d",
                "text": "Post in #general 'is prod down?'",
                "correct": False,
                "feedback": "Use the incident channel and start investigating!",
            },
        ],
    },
    {
        ...
        "options": [
            {
                "id": "a",
                "text": "Tell users to click 'Advanced → Proceed'",
                "correct": False,
                "feedback": "Never ask users to bypass cert warnings in prod.",
            },
            {
                "id": "b",
                "text": "Renew cert via ACM/Let's Encrypt & update ALB listener",
                "correct": True,
                "feedback": "Cert renewal is the fix. Set up auto-renewal alerts next time!",
            },
            {
                "id": "c",
                "text": "Switch to HTTP only",
                "correct": False,
                "feedback": "Downgrading to HTTP is a security incident, not a fix.",
            },
            {
                "id": "d",
                "text": "Wait for it to fix itself",
                "correct": False,
                "feedback": "Certs don't self-heal. Renew it!",
            },
        ],
    },
    {
        ...
        "options": [
            {
                "id": "a",
                "text": "Flush all keys immediately",
                "correct": False,
                "feedback": "Flushing might cause a thundering herd. Triage first.",
            },
            {
                "id": "b",
                "text": "Evict stale keys, increase memory limit, check for key explosion",
                "correct": True,
                "feedback": "Proper cache triage — evict, scale, and find the root cause.",
            },
            {
                "id": "c",
                "text": "Disable caching entirely",
                "correct": False,
                "feedback": "That'll melt your database. Fix Redis instead.",
            },
            {
                "id": "d",
                "text": "Restart Redis every 5 minutes via cron",
                "correct": False,
                "feedback": "Cron restarts are a band-aid, not a strategy.",
            },
        ],
    },
    {
        ...
        "options": [
            {
                "id": "a",
                "text": "Truncate production tables to free space",
                "correct": False,
                "feedback": "Never truncate prod to fix disk space. Find what's filling the disk.",
            },
            {
                "id": "b",
                "text": "Rotate logs, expand volume, identify runaway growth",
                "correct": True,
                "feedback": "Classic disk triage — free space now, expand capacity, find the leak.",
            },
            {
                "id": "c",
                "text": "Reboot the server and hope for the best",
                "correct": False,
                "feedback": "A reboot won't shrink your logs or WAL files.",
            },
            {
                "id": "d",
                "text": "Disable monitoring so alerts stop",
                "correct": False,
                "feedback": "Silencing alerts is not incident response.",
            },
        ],
    },
    {
        ...
        "options": [
            {
                "id": "a",
                "text": "Check Route53/Cloudflare records & TTL propagation",
                "correct": True,
                "feedback": "DNS issues start at the registrar — verify records and propagation.",
            },
            {
                "id": "b",
                "text": "Redeploy the application",
                "correct": False,
                "feedback": "The app is fine internally. This is a DNS problem.",
            },
            {
                "id": "c",
                "text": "Flush DNS on every user's machine",
                "correct": False,
                "feedback": "You can't flush DNS for the entire internet.",
            },
            {
                "id": "d",
                "text": "Switch to IP addresses in the docs",
                "correct": False,
                "feedback": "Hardcoding IPs is fragile and won't scale.",
            },
        ],
    },
]
...
DEPLOY_SCENARIOS = [
    {
        ...
        "options": [
            {
                "id": "deploy",
                "text": "🚀 Deploy now — it's just a config change!",
                "correct": False,
                "points": 0,
                "feedback": "Friday deploys without rollback plans? Bold. Also wrong.",
            },
            {
                "id": "rollback",
                "text": "🛑 Wait until Monday with a tested rollback plan",
                "correct": True,
                "points": 100,
                "feedback": "Zero Downtime Hero move! Ship Monday with confidence.",
            },
            {
                "id": "canary",
                "text": "🐤 Canary deploy with 5% traffic & auto-rollback",
                "correct": True,
                "points": 80,
                "feedback": "Solid compromise — canary with auto-rollback is acceptable.",
            },
            {
                "id": "yolo",
                "text": "🔥 Deploy AND delete staging to save costs",
                "correct": False,
                "points": -50,
                "feedback": "You monster. Never delete staging before a deploy.",
            },
        ],
    },
    {
        ...
        "options": [
            {
                "id": "wait",
                "text": "⏳ Wait 30 min — might be cache warming",
                "correct": False,
                "points": 0,
                "feedback": "8% error rate is not cache warming. Roll back!",
            },
            {
                "id": "rollback",
                "text": "⏪ Rollback immediately to v2.4.0",
                "correct": True,
                "points": 100,
                "feedback": "Correct! Roll back first, investigate later.",
            },
            {
                "id": "scale",
                "text": "📈 Scale up replicas to 20",
                "correct": False,
                "points": 20,
                "feedback": "Scaling won't fix application errors. Roll back.",
            },
            {
                "id": "deploy",
                "text": "🚀 Deploy v2.4.2 hotfix right now",
                "correct": False,
                "points": 0,
                "feedback": "Deploying on top of a broken deploy? Double trouble.",
            },
        ],
    },
    {
        ...
        "options": [
            {
                "id": "abort",
                "text": "🛑 Abort migration & rollback schema",
                "correct": False,
                "points": 30,
                "feedback": "Aborting mid-migration can corrupt data. Assess first.",
            },
            {
                "id": "continue",
                "text": "✅ Continue migration with read-only mode enabled",
                "correct": True,
                "points": 100,
                "feedback": "Smart! Enable read-only, finish migration, then restore writes.",
            },
            {
                "id": "deploy",
                "text": "🚀 Deploy new app version to fix 500s",
                "correct": False,
                "points": 0,
                "feedback": "The 500s are from the migration, not the app version.",
            },
            {
                "id": "ignore",
                "text": "😴 It's fine, migrations always cause blips",
                "correct": False,
                "points": -20,
                "feedback": "3.5% errors aren't blips. Take action.",
            },
        ],
    },
    {
        ...
        "options": [
            {
                "id": "never",
                "text": "🏆 Keep the uptime streak! Patch never.",
                "correct": False,
                "points": -100,
                "feedback": "847 days of uptime, 1 day of breach headlines.",
            },
            {
                "id": "deploy",
                "text": "🔒 Schedule rolling restart with security patch",
                "correct": True,
                "points": 100,
                "feedback": "Security patches don't wait for uptime trophies.",
            },
            {
                "id": "rollback",
                ...
                "correct": False,
                "points": 0,
                "feedback": "Rollback removes the patch. You need to apply it!",
            },
            {
                "id": "firewall",
                "text": "🧱 Block all inbound traffic instead",
                "correct": False,
                "points": -50,
                "feedback": "That's called 'taking prod offline'. Patch it.",
            },
        ],
    },
]
